...
지난주 과제를 통해 데이터셋에 대한 탐색과 EDA를 마친 뒤, 변수 간의 관계를 파악하고 다양한 인사이트를 도출해주셨을 것으로 기대합니다! 이제 3주차 과제에서는 **수치형 변수 간 상관관계 파악(EDA)**과 **피쳐 엔지니어링**에 집중해보겠습니다. 이를 통해 데이터의 패턴을 더 깊이 이해하고, 정교한 분석을 할 수 있도록 세팅을 마무리해봅시다.
